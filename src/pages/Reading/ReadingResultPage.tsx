...
export default function ReadingResultPage() {
  ...
  const interpretationRequest = useMemo((): InterpretationRequest | null => {
    if (!session || !spread || !allCards || allCards.length === 0) return null;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      ...
      >
          ...
          return (
            ...
            >
              ...
              <div style={{ padding: 16, display: "flex", gap: 14 }}>
                ...
                <div style={{ flex: 1 }}>
                  <p
                    style={{ fontSize: 12, color: "#a78bfa", marginBottom: 6 }}
                  >
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() =>
                interpretationRequest && generate(interpretationRequest)
              }
              style={{
                padding: "12px",
                borderRadius: 10,
              ...
              interpretation && (
                <div
                  style={{
                    ...
                    // 스트리밍 중임을 커서로 표시
                    borderRight:
                      status === "streaming" ? "2px solid #a78bfa" : "none",
                  }}
                >
                  {interpretation}
                </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <label style={{ fontSize: 14, color: "#a78bfa" }}>
            나의 해석 & 노트
          </label>
          <textarea
            value={notes}
